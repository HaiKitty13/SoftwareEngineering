...
class ProfileUserFollowingAdapter(
    private val profiles: List<User>,
    private val onItemClick: (String) -> Unit
) : RecyclerView.Adapter<ProfileUserFollowingAdapter.ProfileUserFollowingViewHolder>() {

    inner class ProfileUserFollowingViewHolder(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProfileUserFollowingViewHolder {
        val view = ProfileItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ProfileUserFollowingViewHolder(view)
    }

    override fun onBindViewHolder(holder: ProfileUserFollowingViewHolder, position: Int) {
